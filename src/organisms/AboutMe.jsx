  ...
  function ImageAvatars() {
    ...
    return (
      <div className={classes.root}>
        <Avatar alt="Ratnesh Murugesan" src="public/assets/ratnesh-murugesan.jpg" className={classes.large} />
      </div>
    );
  }
            ...
            <Grid container spacing={3} direction="row" justify="center" alignItems="center">
                <Grid item xs={11}>
                    <Paper elevation={4} className="paper">
                        ...
                        <ImageAvatars />
                        <p>I hope you are landing on this site and started exploring about me.</p>
                        <p>I really thank you for spending your time to know about me;</p>
                        <p>I guarantee that the stuffs you see here will be different that you seen in my resume.</p>
                        <p>Please go ahead!</p>
                        <p>Enjoy Exploring!!</p>
                    </Paper>
                </Grid>
                <Grid item xs={11}>
                    <Paper elevation={4} className="paper">
                        ...
                        <p>- I Avoid, nested loops or nested iterators(ForEach, Map, Filter, etc..) 
                            which costs performance as the runtime of that block code will take O(n2) to complete, instead I chain/curry one by one which will take O(n)
                            </p>
                    </Paper>
                </Grid>
