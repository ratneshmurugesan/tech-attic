...
const UserJourneyWithHooks = () => {
  ...
  const { tiles, currentTileProps, addedIcon } = superState;
  ...
  const icons = [
    <span
      key="ChildFriendlyIcon"
      draggable="true"
      onDragStart={drag}
      className="user-journey__icon"
      id="ChildFriendlyIcon"
    >
      <ChildFriendlyIcon className={classes.iconStyle} />
    </span>,
    <span
      key="AcUnitIcon"
      draggable="true"
    ...
    <span
      ...
      id="MotorcycleIcon"
    >
      <MotorcycleIcon className={classes.iconStyle} />
    </span>,
    <span
      key="OfflineBoltIcon"
      draggable="true"
    ...
    <span
      key="ShutterSpeedIcon"
      draggable="true"
      onDragStart={drag}
      className="user-journey__icon"
      id="ShutterSpeedIcon"
    >
      <ShutterSpeedIcon className={classes.iconStyle} />
    </span>,
    <span
      key="QueuePlayNextIcon"
      draggable="true"
      onDragStart={drag}
      className="user-journey__icon"
      id="QueuePlayNextIcon"
    >
      <QueuePlayNextIcon className={classes.iconStyle} />
    </span>,
    <span
      key="WhatshotIcon"
      draggable="true"
    ...
    >
      <SportsEsportsIcon className={classes.iconStyle} />
    </span>,
  ];
  /* 
  ...
  useEffect(() => {
    ...
    const createTiles = ({ tileID, addedIcon }) => {
      return {
        tileID,
        addedIcon,
        ele: React.createElement("div", {
          ...
          children: [
            React.createElement("span", {
              ...
              children: (
                <HighlightOffIcon
                  className={classes.forwardIconWithTransformSize30}
                />
              ),
            }),
            React.createElement("span", {
              ...
              children: (
                <ForwardIcon
                  className={classes.forwardIconWithTransformSize50}
                />
              ),
            }),
    ...
    const createTilesWithClose = ({ tileID, addedIcon }) => {
      return {
        tileID,
        addedIcon,
        ele: React.createElement("div", {
            ...
            React.createElement("span", {
              ...
              children: (
                <div className="arrow-group">
                  <ForwardIcon
                    className={classes.forwardIconWithTransformStyle}
                  />
                  <ForwardIcon
                    className={classes.forwardIconWithTransformSize30}
                  />
    ...
    setSuperState(pState => {
      ...
      if (!currentTileProps.tileID) {
        const finalItems = [
          ...pState.tiles,
          createTiles(currentTilePropWithIcon),
        ];
